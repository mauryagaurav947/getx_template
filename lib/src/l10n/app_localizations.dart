...
abstract class AppLocalizations {
  ...
  /// No description provided for @goToCountersPage.
  ///
  /// In en, this message translates to:
  /// **'GO TO COUNTERS PAGE'**
  String get goToCountersPage;
  ...
  /// Update message if the app is not updated
  ///
  /// In en, this message translates to:
  /// **'Seems like you are not using the update version of app. You are using {appVersion} and the current version is {remoteVersion}'**
  ...
  /// No description provided for @signInWelcomeMsg.
  ///
  /// In en, this message translates to:
  /// **'Welcome back you\'ve\nbeen missed!'**
  String get signInWelcomeMsg;
